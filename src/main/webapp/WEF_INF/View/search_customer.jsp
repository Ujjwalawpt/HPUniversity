                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Customer Id Here">
                            </div>
                            <div class="mb-3 text-center">
                                <button class="btn btn-lg btn_red btn-primary" onclick="location.href='/loadCustomerData'">Fetch Details</button>
                            </div>
                        </div>
                    </div>
                </div>
